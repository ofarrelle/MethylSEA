...
"                  originating from the original top strand. Suggested values are\n"
"                  printed to the stderr log of the MBias program. Each integer\n"
"                  represents a 1-based position on a read. For example --OT A,B,C,D\n"
